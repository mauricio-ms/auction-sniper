...
public class LoggingXMPPFailureReporter implements XMPPFailureReporter {
    ...
    @Override
    public void cannotTranslateMessage(String auctionId, String badMessage, Exception exception) {
        logger.severe(String.format(MESSAGE_FORMAT, auctionId, badMessage, exception.toString()));
    }
}
